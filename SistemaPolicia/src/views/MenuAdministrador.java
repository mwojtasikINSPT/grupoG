...
public class MenuAdministrador {
    ...
    public void mostrarMenu(Usuario usuarioLogueado) {
        ...
        do {
            ...
            switch (opcion) {
                case 1 -> new GestionUsuarios().mostrar(Rol.ADMINISTRADOR, usuarioLogueado.getUsername());
                case 2 -> new GestionOperativa().mostrar(Rol.ADMINISTRADOR);
                case 0 -> UIHelper.imprimirMensaje("\n[SISTEMA] Cerrando sesión...");
